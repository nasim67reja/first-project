    ...
    <>
      ...
      >
        <Swiper
          ...
          className="mySwiper w-fit translate-x-[-3rem] sm:translate-x-0"
        >
          <SwiperSlide>
        ...
        <div
          ...
          style={{ position: "absolute", left: "0", color: "#C7C7C7" }}
        ></div>
        <div
          className="swiper-button-next"
          style={{ position: "absolute", right: "0", color: "#C7C7C7" }}
        ></div>
      </div>
    </>
  );
...
const Slide = ({ data }) => {
  return (
    <>
      <div className="w-[38rem] sm:w-[44rem] xl:w-[355px] bg-[#D9D9D9]   p-[1.6rem] rounded-[5px] border-[0.5px] border-[#A5A5A5] h-[500px] lg:h-[550px]  transition-all duration-500">
